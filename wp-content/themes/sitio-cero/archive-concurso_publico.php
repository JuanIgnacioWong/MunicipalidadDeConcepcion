        ...
        <div class="pc-page">
            <section class="pc-hero">
                <div class="pc-hero__inner">
                    ...
                    <h1 class="pc-hero__title"><?php esc_html_e('Concursos Públicos', 'sitio-cero'); ?></h1>
                    <p class="pc-hero__lead">
                        <?php esc_html_e('Repositorio de concursos públicos vigentes y cerrados, con sus documentos oficiales y antecedentes.', 'sitio-cero'); ?>
                    </p>
                </div>
            </section>
